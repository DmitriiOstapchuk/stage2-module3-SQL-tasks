...
alter table mark add constraint mark_constraint check (mark between 1 to 10), alter column student_id BIGINT not null, alter column subject_id BIGINT NOT null;
